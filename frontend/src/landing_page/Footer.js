    ...
    return (
        <footer className="border-top mt-5" style={{backgroundColor:"#FBFBFB"}}>
            <div className='container'>
                ...
                <p className="d-flex gap-4 justify-content-center" style={{fontSize:"12px"}}>
                    ...
                    <a href='#'style={{textDecoration:"none"}}>Privacy polocy</a>
                    <a href='#'style={{textDecoration:"none"}}>Disclosure</a>
                    <a href='#'style={{textDecoration:"none"}}>For inverstor's attention</a>
